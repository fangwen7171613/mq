...
int main(const int argc, char* argv[])
{
    ...
    const SInitMqSdkParam param = {.m_pMqMsgCb = &g_testCallback, .m_pszWorkRoot = NULL, .m_pTopicArray = topicList, .m_nTopicCount = 2, .m_nClientID = 1};
...
void PubTopicMsg(void)
{
    ...
    const STopicMsg msg = {.m_nTopicID = 5, .m_nMsgSize = sizeof(int), .m_pMsg = (char*)&i};
